...
ResourceManager:RegisterInstanceLoadHandler(s_PGUID_ApcsSplash, s_IGUID_ApcsSplash, function(p_LoadedInstance)
    ...
    s_VeniceExplosionEntityData.innerBlastRadius = 7.0
    s_VeniceExplosionEntityData.blastDamage = 100.0
    s_VeniceExplosionEntityData.blastRadius = 10.0
    s_VeniceExplosionEntityData.shockwaveDamage = 100.0
    s_VeniceExplosionEntityData.shockwaveRadius = 4.0
    s_VeniceExplosionEntityData.shockwaveImpulse = 40.0
    s_VeniceExplosionEntityData.shockwaveTime = 0.20
